...
let aluno1: [string, number, number, number] = ['João', 8, 7, 10]
let aluno2: [string, number, number, number] = ["Maria", 9, 10, 10];
let aluno3: [string, number, number, number] = ["Julia", 5, 6, 6];
let result     
