...
console.log(
  a == b ? "O valor de [a] é igual a [b]" : "O valor de [a] é difente de [b]"
);
...
console.log(
  !(f = true) ? "A função booleana é verdadeira" : "A função buleana é falsa"
);
...
console.log(
  a > 0 ? "O valor de [a] é  maior que  0" : "O valor de [a] é menor 0"
);
...
console.log(
  c == "" ? "A função [c] está vazia" : "A função [c] não está vazia",
  " - Valor: " + c.length
);
